...
*Manages the upgradeability and initialization of staker nodes*
...
*Only callable by accounts with STAKER_NODE_CREATOR_ROLE*
...
*This function is internal and called during node creation and upgrades*
...
### registerStakerNodeImplementation

Registers the initial staker node implementation

*Can only be called once by an account with DEFAULT_ADMIN_ROLE*


```solidity
function registerStakerNodeImplementation(address _implementationContract)
    public
    override
...
|Name|Type|Description|
|----|----|-----------|
|`_implementationContract`|`address`|Address of the implementation contract|
