...
// forge script script/tasks/TRO_UpdateRate.s.sol:UpdateRate --rpc-url http://localhost:8545 --broadcast --private-key $ADMIN_PRIVATE_KEY --sig "run(string,address,uint256)" -- "/local/deployment_data.json" <TOKEN> <PRICE> -vvvv
contract UpdateRate is Script, Test {
